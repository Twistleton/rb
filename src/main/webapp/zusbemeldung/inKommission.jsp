...
<%
    ...
    out.println("<TD>ZS-Sys</TD><TD ALIGN=\"right\">");
    ...
    out.println("<TD ALIGN=\"CENTER\"><A HREF=\"inKommission.jsp?sort=kom_sammel_abnr\">S-AB-Nr</A></TD>");
    out.println("<TD ALIGN=\"CENTER\"><A HREF=\"inKommission.jsp?sort=min(kom_fabt_zuschn)\">Zuschnitt-Tag</A></TD>");
    out.println("<TD ALIGN=\"CENTER\"><A HREF=\"inKommission.jsp?sort=sum(kom_qm_brutto)\">Brutto-Menge</A></TD>");
    out.println("<TD ALIGN=\"CENTER\"><A HREF=\"inKommission.jsp?sort=kom_werk_zuschn\">Werk</A></TD>");
    out.println("<TD ALIGN=\"CENTER\"><A HREF=\"inKommission.jsp?sort=kom_zs_sys\">Zus-System</A></TD></TR>");
    while (rs.next()) {
        sumQm += rs.getFloat(3);
        out.println("<TR><TD>");
