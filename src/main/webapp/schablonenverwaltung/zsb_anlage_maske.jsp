...
<form action="./anlegen.jsp?art=zsb" method="post">
    ...
    <table border="1" align="center">
        <tr>
            ...
            <td>
                <input type="text" name="zsb" size="6" maxlength="6" value=<%=zsb%>></input>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="zsb23" size="6" maxlength="6" value=<%=zsb%> readonly></input>
                <input type="text" name="material" size="1" maxlength="1" value="8"></input>
            </td>
        </tr>
        <tr>
            <td align="center">
