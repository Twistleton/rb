...
<%
    ...
    out.println("<center><h3>Bezeichnung &auml;ndern:</h3></center>");
    out.println("<form action=\"./bezedit_update.jsp\" method=\"post\">");
    ...
    try {
        ...
        out.println("<input type=\"text\" name=\"artBez\" value=\"" + artBez + "\" maxlength=\"24\"></input>");
        ...
        out.println("<tr><td>Zuschnittsystem</td><td align=\"center\">" + zsArt + "</td></tr></table>");
