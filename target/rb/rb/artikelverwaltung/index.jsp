...
<table width="100%">
    <tr>
        <td align="left" width="130"><a href="http://jakarta.apache.org/tomcat/index.html"><img src="tomcat.gif"
                                                                                                height="92" width="130"
                                                                                                border="0"
        ...
        <td align="right"><a href="http://jakarta.apache.org/"><img src="jakarta-banner.gif" height="48" width="505"
                                                                    border="0" alt="The Jakarta Project"></a></td>
    </tr>
</table>
...
<table>
    <tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#000000">
                ...
                <tr>
                    <td bgcolor="#FFDC75" bordercolor="#000000" nowrap>
                        ...
                        <a href="http://www.mail-archive.com/tomcat-user%40jakarta.apache.org/">Users Mailing
                            List</a><br>
                        <a href="http://www.mail-archive.com/tomcat-dev%40jakarta.apache.org/">Developers Mailing
                            List</a><br>
        ...
        <td align="left" valign="top">
            <p>
            <center><b>If you're seeing this page via a web browser, it means you've setup Tomcat successfully.
            ...
            <p>Included with this release are a host of sample Servlets and JSPs (with associated source code),
                extensive documentation (including the Servlet 2.3 and JSP 1.2 API JavaDoc), and an introductory guide
                to developing web applications.</p>

            <p>Tomcat mailing lists are available at the Jakarta project web site:</p>

            <ul>
                <li><b><a href="mailto:tomcat-user-subscribe@jakarta.apache.org">tomcat-user@jakarta.apache.org</a></b>
                    for general questions related to configuring and using Tomcat
                </li>
                <li><b><a href="mailto:tomcat-dev-subscribe@jakarta.apache.org">tomcat-dev@jakarta.apache.org</a></b>
