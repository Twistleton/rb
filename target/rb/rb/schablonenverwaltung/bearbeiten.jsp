...
<table border="0" align="center" cellspacing="5">
	  ...
	  if(art.equals("zsb")){ 
	     ...
	     try
	     {
	       ...
	       out.println("<input type=\"text\" name=\"zsb23\" size=\"6\" maxlength=\"6\" value="+zsbID+" readonly></input>");
	       out.println("<input type=\"text\" name=\"material\" size=\"1\" maxlength=\"1\" value="+cutterSb+"></input></td></tr>");
