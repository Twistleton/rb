            ...
            if ((auftrag != null) && !(auftrag.compareTo("null") == 0)) { // ABNR ?
                ...
                if (auftrag.length() == 6 && request.getParameter("auswahl") != null) { // ABNR=6 Stellen
                    ...
                    if (request.getParameter("anzeige") != null) {
                        ...
                        sql += "FROM plrv11.plr_ga_dat where ga_zulief=4 and ga_status in (2,8,9,15) ";
                        ...
                        out.println("<p><a href=EFmelden.jsp>neuer Versuch/Neustart</a></p>");
                    }
                }
            } else { // Einstiegsmaske
                ...
                out.println("<font FACE=\"ARIAL\" SIZE=\"5\"><b>Auftrag Anmelden EFP</b></font></td>");
