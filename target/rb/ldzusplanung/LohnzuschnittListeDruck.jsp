<%-- Lohnzuschnitt - Stand 16.06.2008			                --%>
...
<html>
<head>
    <title>Liste: Lohnzuschnitt</title>
...
/* ***************************************************** */
    ...
    kdd.oeffnen();
    kdd.satzEinfuegen("ZULKOM LF " + aktFabt + " 10\n");
    ...
    if (anzDatensaetze > 0) {
        ...
        sql += " kom_kom_kz='J',";
        sql += " kom_status=40 ,";
        sql += " kom_tagesmenge_dat=SYSDATE ";
        sql += " WHERE  kom_kom_kz='N' ";
        sql += " AND kom_status<10 ";
        sql += " AND kom_zs_sys=11 ";
        sql += " AND kom_prog NOT IN (SELECT prg_prg FROM plrv11.plr_prg_sperr) ";
