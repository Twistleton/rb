...
<%
    ...
    if (art.equals("zsb")) {
        ...
        String cutterSb = cutterSb1 + cutterSb2;
        ...
        if (cutterSb1.length() != 6) {
            out.println("Eingabe für LD-Cutter-SB muss 6 Stellen umfassen! ");
        } else {

            sql = "UPDATE PLRV11.ZUS_SCHNITTBILD SET SB_AUSL_DAT=" + datString + ",SB_CUTTER_SB='" + cutterSb + "',SB_PFAD='" + pfad + "',";
