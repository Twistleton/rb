...
<%
    ...
    if (art.equals("zsb")) {
        ...
        String cutterSb1 = request.getParameter("cutterSb1");
        String cutterSb2 = request.getParameter("cutterSb2");
        ...
        java.util.regex.Matcher m = p.matcher(cutterSb1);

        if (m.find() == false || cutterSb1.length() != 6) {
            out.println("Die Eingabe für LD-Cutter-SB muss 6 Stellen umfassen! Verwenden Sie den Button für 'eine Seite zurück' und korrigieren Sie den Fehler!");
        } else {
