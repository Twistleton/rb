...
<%
    ...
    if (var.equals("zsb")) {
        ...
        try {
            ...
            sb_cutter_sb = resultSet.getString("SB_CUTTER_SB");
            ...
            out.println("<tr><td>Cutter SB</td><td>" + sb_cutter_sb + "</td></tr>");
...
<table border="0" align="center">
    ...
    <tr>
        <td>
            <form action="./loeschen.jsp?typ=<%=typ%>&anlJahr=<%=anlJahr%>&ID=<%=sbID%>&matKZ=<%=matKZ%><&sb_cutter_sb=<%=sb_cutter_sb%>&hkkID=<%=hkkID%>&lfdNr=<%=lfdNr%>"
                  method="post">
        </td>
    </tr>
    <tr>
