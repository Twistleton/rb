...
<%
    ...
    cutterSb = request.getParameter("sb_cutter_sb");
    cutterSb1  = cutterSb.substring(0,6);
	matKZ  = cutterSb.substring(6);
    ...
    if (typ.equals("zsb")) {
        if (delete.equals("1")) {
            ...
            sql = "DELETE FROM PLRV11.ZUS_SCHNITTBILD WHERE SB_ID=" + sbID + " AND SB_CUTTER_SB='" + cutterSb + "' AND SB_ANL_JAHR=" + anlJahr;
